...
<opml version="1.1">
<head>
<title>LifeDesks MediaRSS Feeds</title>
<dateCreated><?php print gmdate('D, d M Y H:i:s O',time()); ?></dateCreated>
</head>
<body>
<outline text="LifeDesks MediaRSS Folder">
<?php
foreach($data as $site) {
  echo '<outline title="' . $site['title'] . '" text="' . $site['title'] . '" type="rss" xmlUrl="http://' . $site['subdomain'] . '.' . $domain[1] . '/gallery/mediarss"></outline>' . "\n";	
}
?>
</outline>
</body>
