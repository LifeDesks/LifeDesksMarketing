...
<opml version="1.1">
<head>
<title>LifeDesks Recent Biblio Submission Feeds</title>
<dateCreated><?php print gmdate('D, d M Y H:i:s O',time()); ?></dateCreated>
</head>
<body>
<outline text="LifeDesks Biblio Folder">
<?php
foreach($data as $site) {
  echo '<outline title="' . $site['title'] . '" text="' . $site['title'] . '" type="rss" xmlUrl="http://' . $site['subdomain'] . '.' . $domain[1] . '/biblio/recent/rss.xml"></outline>' . "\n";
}
?>
</outline>
</body>
