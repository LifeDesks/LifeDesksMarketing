...
<p id="module-introduction"><a href="http://drupal.org">Drupal</a> is the platform of choice for LifeDesks. Modules created for LifeDesks are available for download from <a href="http://github.com/LifeDesks">GitHub</a>.</p>
<p>Interested in multisite hosting your own LifeDesk platform? <a href="/files/LifeDesks-Whitepaper.pdf">Read our white paper <img src="../images/page_white_acrobat.png" alt="PDF (200 KB)" /></a> on how we did it.</p>
<?php
